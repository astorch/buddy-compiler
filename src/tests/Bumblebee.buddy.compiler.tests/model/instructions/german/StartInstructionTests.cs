    ...
    public class StartInstructionTests {
        ...
        class TestCaseFactory {
            public IEnumerable<TestCaseData> TestCases {
                get {
                    yield return new TestCaseData(@"Starte ""C:\EGUB\EGUB.exe"".").Returns(EvaluationResult.Ok);
                    ...
                    yield return new TestCaseData("Starte {Verwaltung}.").Returns(new _ErrorEvaluationResult("2nd word of instruction does not match expected token 'Parameter reference 'path' (string)'. Word is '{Verwaltung}'"));
                }
            }
        }
    }
